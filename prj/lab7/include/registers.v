...
`define DEVICE_PROJ_NAME   "CPU"
`define DEVICE_PROJ_DESC   "5 stage pipeline cpu"
...
// Name: gpu
// Description: Registers for GPU
// File: projects/lab7/include/gpu.xml
`define GPU_IMEM_ADDR        4'h0
`define GPU_IMEM_DATA        4'h1
`define GPU_DMEM_ADDR        4'h2
`define GPU_DMEM_WR_DATA_LO  4'h3
`define GPU_DMEM_WR_DATA_HI  4'h4
`define GPU_GPU_CTRL         4'h5
`define GPU_CURRENT_PC       4'h6
`define GPU_DMEM_RD_DATA_LO  4'h7
`define GPU_DMEM_RD_DATA_HI  4'h8
`define GPU_CYCLE_COUNTS     4'h9
`define GPU_GPU_STATUS       4'ha
