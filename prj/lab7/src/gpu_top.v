...
module gpu_top (
    ...
    // External dmem read/write port (ARM access)
    input  [9:0]  ext_dmem_addr,
    input  [63:0] ext_dmem_wdata,
    input         ext_dmem_we,
    output [63:0] ext_dmem_rdata
);
    ...
    // === Data Memory ===
    // When rst is asserted, ARM has control; otherwise GPU has control
    wire [63:0] dmem_rdata;
    wire [9:0]  dmem_addr_mux = rst ? ext_dmem_addr : dmem_addr;
    wire [63:0] dmem_din_mux  = rst ? ext_dmem_wdata : rf_b;
    wire        dmem_we_mux   = rst ? ext_dmem_we : dmem_we;
    ...
    assign ext_dmem_rdata = dmem_rdata;
