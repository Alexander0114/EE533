...
module control_unit (
    ...
    // Two-stage sign extension to avoid XST issues with 47-bit replication
    wire [31:0] imm_sext_lo = {{15{imm17[16]}}, imm17};
    wire [63:0] imm_sext    = {{32{imm_sext_lo[31]}}, imm_sext_lo};
