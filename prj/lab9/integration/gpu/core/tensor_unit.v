/* file: tensor_unit.v
 Description: 4-lane BF16 tensor unit. Instantiates four bf16_lane modules
   for parallel BF16 ADD/MUL/FMA operations. 4-stage pipeline depth.
 Author: Raymond
 Date: Feb. 23, 2026
 Version: 1.0
 Revision History:
...
`timescale 1ns / 1ps
`ifndef TENSOR_UNIT_V
`define TENSOR_UNIT_V
module tensor_unit (
    input         clk,
    input         rst,
    input         start,
