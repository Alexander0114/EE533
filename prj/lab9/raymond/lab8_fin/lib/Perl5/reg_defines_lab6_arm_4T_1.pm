...
#
# Project: CPU (lab6_arm_4T_1)
# Description: 5 stage pipeline cpu
#
#############################################################

package reg_defines_lab6_arm_4T_1;
...
@EXPORT = qw(
                ...
                CPU_CPU_CTRL_REG
                CPU_CURRENT_PC_REG
                CPU_DMEM_DATA_LOW_RD_REG
                CPU_DMEM_DATA_HIGH_RD_REG
                CPU_CYCLE_COUNTS_REG
...
sub DEVICE_PROJ_DIR ()  { "lab6_arm_4T_1"; }
sub DEVICE_PROJ_NAME () { "CPU"; }
sub DEVICE_PROJ_DESC () { "5 stage pipeline cpu"; }
...
# File: projects/lab6_arm_4T_1/include/cpu.xml
sub CPU_IMEM_ADDR_REG ()           { 0x2000200;}
sub CPU_IMEM_DATA_REG ()           { 0x2000204;}
sub CPU_DMEM_ADDR_REG ()           { 0x2000208;}
sub CPU_DMEM_DATA_REG ()           { 0x200020c;}
sub CPU_CPU_CTRL_REG ()            { 0x2000210;}
sub CPU_CURRENT_PC_REG ()          { 0x2000214;}
sub CPU_DMEM_DATA_LOW_RD_REG ()    { 0x2000218;}
sub CPU_DMEM_DATA_HIGH_RD_REG ()   { 0x200021c;}
sub CPU_CYCLE_COUNTS_REG ()        { 0x2000220;}
