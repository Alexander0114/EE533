...
module network_processor_top #(
    ...
    wire [31:0] cpu_pc_reg;
    wire [31:0] fifo_status;
    wire [31:0] cpu_ctrl_reg;
    ...
    generic_regs #(
        ...
        // HW regs: {cpu_ctrl_reg, fifo_status, cpu_pc_reg, gpu_status, cycle_counts, gpu_pc}
        .hardware_regs({cpu_ctrl_reg, fifo_status, cpu_pc_reg, gpu_status, cycle_counts, gpu_pc}),
    ...
    // Debug registers readable from host
    assign cpu_pc_reg   = {23'b0, cpu_debug_pc};
    assign fifo_status  = {14'b0, ctrl_packet_ready, ctrl_send_packet,
                           ctrl_head_ptr, ctrl_tail_ptr};
    assign cpu_ctrl_reg = {27'b0, ctrl_gpu_rst, ctrl_gpu_run,
                           ctrl_send_packet, ctrl_mode_select,
                           ctrl_packet_ready};
