...
//
// Module: registers.v
// Project: Network Processor (lab8)
// Description: Project specific register defines
//
//              CPU + GPU Network Processor
//
///////////////////////////////////////////////////////////////////////////////
...
`define DEVICE_PROJ_NAME   "Network Processor"
`define DEVICE_PROJ_DESC   "CPU + GPU Network Processor"
...
`define GPU_BLOCK_ADDR            19'h00004
...
// Name: gpu
// Description: Network Processor registers (CPU+GPU)
// File: projects/lab8/include/gpu.xml
`define GPU_CPU_IMEM_ADDR  4'h0
`define GPU_CPU_IMEM_DATA  4'h1
`define GPU_GPU_IMEM_ADDR  4'h2
`define GPU_GPU_IMEM_DATA  4'h3
`define GPU_SYS_CTRL       4'h4
`define GPU_GPU_PC         4'h5
`define GPU_CYCLE_COUNTS   4'h6
`define GPU_GPU_STATUS     4'h7
`define GPU_CPU_PC         4'h8
`define GPU_FIFO_STATUS    4'h9
`define GPU_CPU_CTRL       4'hA
